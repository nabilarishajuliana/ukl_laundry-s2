...
if($_POST){
    ...
    if(empty($jenis)){
        echo "<script>alert('jenis tidak boleh kosong');location.href='ubah_user.php';</script>";
    } elseif(empty($harga)){
        echo "<script>alert('harga tidak boleh kosong');location.href='ubah_user.php';</script>";
    } else {
        include "koneksi.php";
