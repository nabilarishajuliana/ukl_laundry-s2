...
if ($status_order['status'] != NULL) {
    ...
    echo "<script>alert('Sukses mengupdate status Paket');location.href='histori_laundry.php';</script>";
} else {
    echo "<script>alert('Gagal mengupdate status Paket');location.herf='histori_laundry.php';</script>";
}